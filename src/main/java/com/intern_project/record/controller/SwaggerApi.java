...
public interface SwaggerApi {
    ...
    ResponseEntity<BaseResponseDTO> createInitialRecord(InitialRecordRequestDTO requestDTO);
    ...
    ResponseEntity<BaseResponseDTO> createFollowupRecord(Long groupId, FollowupRecordRequestDTO requestDTO);
    ...
    ResponseEntity<BaseResponseDTO<List<RecordHistoryListResponseDTO>>> getRecords(RecordHistoryListRequestDTO requestDTO);
    ...
    ResponseEntity<BaseResponseDTO<RecordDetailResponseDTO>> getRecordDetail(Long recordId);
    ...
    ResponseEntity<BaseResponseDTO<RecordGroupResponseDTO>> getRecordGroups();
